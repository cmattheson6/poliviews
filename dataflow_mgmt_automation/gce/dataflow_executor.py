...
dataflow_task = "git pull origin " \
              "&& python ../../runner_pipelines/senate_members_df.py " \
              " --setup=../../runner_pipelines/setup.py --experiments=allow_non_updatable_job parameter " \
              "&& python ../../runner_pipelines/house_members_df.py " \
              " --setup=../../runner_pipelines/setup.py --experiments=allow_non_updatable_job parameter "
